...
function DarkFooterMenu({
  ...
  return (
    <nav className="grid grid-cols-1 md:grid-cols-2 gap-8" role="navigation">
          ...
          {group?.map((item) => {
            ...
            return isExternal ? (
              ...
              <NavLink
                ...
                to={url}
                className={({isActive}) =>
                  `block text-gray-400 hover:text-cyan-400 transition-colors duration-300 ${
